...
@Autonomous(name="MoyWallRedRight")
public class MoyeWallRedRight extends LinearOpMode {
...
//        signal = 1;
        ...
        if (signal == 2) {
            //setup
            //Setup
            robot.set_place(2, false);
            robot.gyroStrafeEncoder(0.6,180,26);
            robot.gyroStrafeEncoder(0.6,-90,12);
        } else if (signal == 3) {
            robot.set_place(3, false);
            robot.gyroStrafeEncoder(0.6,180, 17);
            robot.gyroStrafeEncoder(0.6,-90,12);
        } else if (signal == 1) {
            robot.set_place(1,false);
            //turns left to go inside
