...
//@Autonomous(name="InsideRedRightCV")
public class InsideRedRightCV extends LinearOpMode {
...
//        signal = 1;
        ...
        if (signal == 2){
            ...
            robot.moveSlides("backboard2", 0.4);
            ...
            robot.gyroStrafeEncoder(0.6, 180, 27);
            ...
            robot.gyroStrafeEncoder(0.6, -90, 8);
            robot.gyroTurn(180, 0.4);
            robot.gyroStrafeEncoder(0.6, 90, 30);
            ...
            robot.closeClaw();
            robot.moveSlides("final", 0.4);
            robot.gyroStrafeEncoder(0.6, 180, 33);
            robot.gyroStrafeEncoder(0.6, 90, 12);
            ...
            robot.gyroStrafeEncoder(0.3, 90, 5.25);
            robot.openClaw();
            sleep(1000);
            jointServo.setPosition(0.42);
            robot.gyroStrafeEncoder(0.6, 270, 2);
            ...
            robot.closeClaw();
            robot.moveSlides("final", 0.4);
            robot.gyroStrafeEncoder(0.6, 180, 25);
            robot.gyroStrafeEncoder(0.6, 90, 12);
...
//            robot.moveSlides("final", 0.4);
//            robot.gyroStrafeEncoder(0.6, 180, 20);
//            robot.gyroStrafeEncoder(0.6, 90, 11);
