...
@Autonomous(name="MoyInsideBlueLeft")
public class MoyeInsideBlueLeft extends LinearOpMode {
...
//        signal = 1;
            ...
            if (signal == 2) {
                //setup
                //Setup
                robot.set_place(2, true);
                robot.moveSlides("move",0.4);
                robot.gyroStrafeEncoder(0.6,180,24);
                robot.gyroStrafeEncoder(0.6,-90,12);
            } else if (signal == 3) {
                robot.set_place(3, true);
                robot.gyroStrafeEncoder(0.6,180, 20);
                robot.gyroStrafeEncoder(0.6,-90,12);
            } else if (signal == 1) {
                robot.set_place(1, true);
                robot.gyroStrafeEncoder(0.6,180,34);
                robot.gyroStrafeEncoder(0.6,-90,12);
