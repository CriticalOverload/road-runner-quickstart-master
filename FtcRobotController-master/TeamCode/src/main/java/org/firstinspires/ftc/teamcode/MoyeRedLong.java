...
@Autonomous(name="MoyRedLong")
public class MoyeRedLong extends LinearOpMode {
...
//        signal = 1;
        ...
        if (signal == 2) {
            //setup
            //Setup
            robot.spike_set_place(2, false);
        } else if (signal == 3) {
            robot.spike_set_place(3, false);
        } else if (signal == 1) {
            robot.spike_set_place(1, false);
