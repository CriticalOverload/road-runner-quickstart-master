...
import org.firstinspires.ftc.teamcode.classification.Classifier;
import org.firstinspires.ftc.teamcode.classification.Classifier.Device;
import org.firstinspires.ftc.teamcode.classification.Classifier.Model;
import org.firstinspires.ftc.teamcode.utils.BorderedText;
import org.firstinspires.ftc.teamcode.utils.ImageUtils;
import org.firstinspires.ftc.teamcode.views.CameraConnectionFragment;
import org.firstinspires.ftc.teamcode.views.LegacyCameraConnectionFragment;

import java.nio.ByteBuffer;
import java.util.List;

public class teachable_machine implements ImageReader.OnImageAvailableListener, Camera.PreviewCallback {
    private static final String TAG = "teachable_machine";
    ...
    public teachable_machine(Model modelType, String modelPath, Context ctx, Telemetry t) throws Exception{
    ...
    public teachable_machine(Model modelType, String modelPath, String labelPath, Context ctx, Telemetry t) throws Exception{
                    ...
                    CameraConnectionFragment.newInstance(
                            new CameraConnectionFragment.ConnectionCallback() {
                                ...
                                public void onPreviewSizeChosen(final Size size, final int rotation) {
                                    ...
                                    teachable_machine.this.onPreviewSizeChosen(size, rotation);
                                }
                            },
                            this,
                            getLayoutId(),
...
//        final int cropSize = Math.min(previewWidth, previewHeight);
    ...
    protected void onInferenceConfigurationChanged() {
        ...
        runInBackground(new Runnable() {
            @Override
            public void run() {
                teachable_machine.this.recreateClassifier(model, device, numThreads);
            }
        });
    }
